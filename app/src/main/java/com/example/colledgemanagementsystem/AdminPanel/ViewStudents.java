...
//                            System.out.println(v.findViewById(R.id.line_c).toString());
                            ...
                            user = (HashMap<String, String>) studentList.get(position);
...
//                        System.out.println("EDIT----");
                ...
                delBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        boolean deleted = db.deleteStudent(Integer.parseInt(Objects.requireNonNull(user.get("ID"))));
                        if (deleted) {
                            studentList.remove(position);
                            notifyDataSetChanged();
                        }
                        String message = deleted ? "Successfully deleted" : "Failed to delete";
                        Toast.makeText(ViewStudents.this, message, Toast.LENGTH_SHORT).show();
                    }
                });
